...
from moving_averages.msft_moving_averages import predictions as ma_prediction
from trading_volumes.microsoft_trading_volume import get_predictions as get_volume_prediction
import numpy as np
