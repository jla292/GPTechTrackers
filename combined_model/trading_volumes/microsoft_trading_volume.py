# -*- coding: utf-8 -*-
"""MicrosoftTradingVolume.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1UegVhCcYUUWUvJrx_wQzhyk2NVAMzCxT
"""
...
def plot_predictions_with_dates(predicted_values, actual_values, dates_2024, historical_dates, historical_prices, actual_dates_2024, actual_prices_2024):
    ...
    plt.title('MSFT Predicted vs. Actual Stock Prices')
    plt.xlabel('Date')
...
def main(patience=3):
    # Load and preprocess data
    df, scaler = load_data("data/MSFT.csv")
