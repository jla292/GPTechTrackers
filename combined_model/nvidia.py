# combined model of market sentiment, moving averages, and trading volumes for NVDA stock
...
def main():
    ...
    nvda_data_2024 = nvda_data[nvda_data['Date'].dt.year == 2024].head(50)

    # Extract actual stock prices for the first 50 days of 2024
    actual_prices = nvda_data_2024['Adj Close'].values
    ...
    plt.title('Actual vs Predicted Stock Prices for NVIDIA in 2024')
    plt.legend()
    plt.grid(True)
