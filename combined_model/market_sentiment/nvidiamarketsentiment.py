...
train_path = os.path.join(os.getcwd(), "data", "nvidia_train.csv")
test_path = os.path.join(os.getcwd(), "data", "nvidia_test.csv")
reg_path = os.path.join(os.getcwd(), "data", "nvidia_stock.csv")
...
for n in range(1):
    ...
    model_save_path = os.path.join(current_dir, f"nvidia_lstm_{n}.pth")

    # Save the model
    save_model(model, model_save_path)

sentiment_model_path = os.path.join(current_dir, "nvidia_lstm_0.pth")
